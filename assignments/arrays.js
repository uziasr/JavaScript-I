...
console.log(inventory[lastItem].car_make,inventory[lastItem].car_model);
...
for (let i =0; i<carYears.length; i++){
  if (carYears[i]<2000){
    oldCars.push(carYears[i]) // -> populates with year
    //oldCars.push(inventory[i]) -> populates with entire car 
  } 
}
